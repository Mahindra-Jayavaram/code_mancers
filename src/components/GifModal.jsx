...
export const GifModal = ({ close }) => {
  const url =
    "https://api.giphy.com/v1/gifs/search?api_key=BGCxUtmq3SeGWJKhI98UpQqcTxebrpQY&limit=20&offset=0&q=";
